/*
	assorted_data_structures.gml
	
	This file contains various data structures used within the game.
*/
//TODO: Currently unused, implement this if the current implementation is too inefficient
#region BlockingList (Class)
function BlockingList() constructor {
...
function PersistentHitbox(_range, _effect, _cooldown) constructor {
	...
	static on_step = function(_entity_type, _storage_list, _ordered = false) {
		range.get_entities_in_range(_entity_type, _storage_list);
