...
linger_timer = 0;
damage_timer = data.seconds_to_damage/2; //Start the first hit of damage sooner, so that the cloud isn't just hovering over the enemy for an odd period of time.
