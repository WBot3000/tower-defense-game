    ...
    case HEALTH_STATE.ACTIVE:
		...
		if(shot_timer >= frames_per_shot) {
			...
			if(ds_list_size(enemies_in_range) > 0) {
				...
				//TODO: Change projectile
				instance_create_layer((self.bbox_left + self.bbox_right)/2, (self.bbox_top + self.bbox_bottom)/2, PROJECTILE_LAYER, piercing_root,
					{
						x_speed: _vector[VEC_X] * other.shot_speed,
						y_speed: _vector[VEC_Y] * other.shot_speed,
						bullet_damage: other.shot_damage,
						pierce_limit: other.shot_pierce
					});
