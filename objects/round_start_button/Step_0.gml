...
enabled = (round_manager != undefined && game_state_manager != undefined && game_state_manager.state == GAME_STATE.RUNNING
	&& round_manager.max_round > round_manager.current_round);
